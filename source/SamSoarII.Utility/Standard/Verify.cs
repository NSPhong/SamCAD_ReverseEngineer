...
internal static class Verify
{
	...
	{
		Standard.Assert.IsNeitherNullNorEmpty(name);
		if (value == null)
		{
	...
	{
		Standard.Assert.IsNeitherNullNorEmpty(parameterName);
		IsNotNull(type, "type");
	...
	{
		Standard.Assert.IsNotNull(parameter);
		Standard.Assert.IsNotNull(interfaceType);
		Standard.Assert.IsTrue(interfaceType.IsInterface);
		bool flag = false;
