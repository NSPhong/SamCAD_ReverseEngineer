...
public class FontManager
{
	...
	public static List<PrintFontData> Prints = new List<PrintFontData>();
	...
	public static void LoadFontDataByXElement(FontData fdat, XElement xele)
	{
		fdat.FontSize = uint.Parse(xele.Attribute("FontSize").Value);
	...
	public static void SaveFontDataToXElement(FontData fdat, XElement xele)
	{
	...
	public static void LoadPrintDataByXElement(XElement xe)
	{
		Prints.Clear();
		foreach (XElement item in xe.Elements("PrintFontData"))
		{
			PrintFontData printFontData = new PrintFontData();
			printFontData.Load(item);
			Prints.Add(printFontData);
		}
	}

	public static void SavePrintDataToXElement(XElement xe)
	{
		foreach (PrintFontData print in Prints)
		{
			XElement xElement = new XElement("PrintFontData");
			print.Save(xElement);
			xe.Add(xElement);
		}
	}
