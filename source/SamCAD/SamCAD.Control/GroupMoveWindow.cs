...
public class GroupMoveWindow : UserControl, IComponentConnector
{
	...
	public Vector Move
	{
		get
		{
			...
			return new Vector(result, result2);
		}
	}

	public GroupMoveWindow()
	{
		InitializeComponent();
	}
	...
	public void InitializeComponent()
	{
		...
		{
			_contentLoaded = true;
			Uri resourceLocator = new Uri("/SamCAD;component/control/groupmovewindow.xaml", UriKind.Relative);
