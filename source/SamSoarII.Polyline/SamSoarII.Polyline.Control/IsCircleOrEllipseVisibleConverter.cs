...
public class IsCircleOrEllipseVisibleConverter : IValueConverter
{
	public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
	{
		return (!(value is IPolylineCircle) && !(value is IPolylineEllipse)) ? Visibility.Collapsed : Visibility.Visible;
	}
