...
public class IsCircleNotArchVisibleConverter : IValueConverter
{
	public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
	{
		return (!(value is IPolylineCircle) || value is IPolylineArch) ? Visibility.Collapsed : Visibility.Visible;
	}
