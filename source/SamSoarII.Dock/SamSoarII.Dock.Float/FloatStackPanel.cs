...
internal class FloatStackPanel : Grid, IDisposable, IDockBaseView, IUserFocus, IDockView
{
	...
	private DockStackPanel content;
	...
	public DockStackPanel ViewContent => content;
	...
	public FloatStackPanel(FloatWindow _parent, DockStackPanel _content)
	{
		parent = _parent;
		content = _content;
